...
import {
  ...
  setSpaceBackground,
  type AirplaneHandle,
} from '@/map/layers/airplane3d.shared'

export type { AirplaneHandle }
...
// MODEL_URL, PLANE_BYTES_FALLBACK, prefetchAirplaneModel : déplacés dans
// airplane3d.shared.ts (partie légère sans three.js, importable par le splash).
...
// SPACE_SKY, setSpaceBackground, prewarmGlobe : déplacés dans airplane3d.shared.ts
// (partie légère sans three.js) ; importés ci-dessus.
...
// airplaneTuning : déplacé dans airplane3d.shared.ts (réglages sans three.js, édités
// live par AirplaneDebugPanel) ; importé ci-dessus.
