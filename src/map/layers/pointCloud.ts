...
// PointCloudHandle : type déplacé dans pointCloud.shared.ts ; ré-exporté ci-dessus.

const LAYER_ID = 'gp-pointcloud'

// POINTCLOUD_ANCHOR : déplacé dans pointCloud.shared.ts ; importé ci-dessus.
...
// MODE, ModeNum, SCAN_MIN/MAX, pointCloudTuning, pointCloudView, CLASS_INFO, CLASS_OTHER,
// classInfo : déplacés dans pointCloud.shared.ts (constantes/état sans three.js) ; les
// symboles utilisés ici sont importés en tête de fichier.
