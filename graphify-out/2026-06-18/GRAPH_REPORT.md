...
Cohesion: 0.31
Nodes (4): CinematicCamera(), MapContext, useMap(), PointCloudDangerPois()
...
Cohesion: 0.09
Nodes (16): AnySource, CADASTRE_TPL, Camera, cancelPrewarm(), DEM_TPL, GLOBE_OVERVIEW_CAM, lngLatToTileXY(), ORTHO_HISTO_TPL (+8 more)
...
Cohesion: 0.05
Nodes (42): allowScripts, sharp@0.34.5, dependencies, class-variance-authority, clsx, driver.js, gsap, @gsap/react (+34 more)
...
Cohesion: 0.11
Nodes (19): devDependencies, @babel/core, babel-plugin-react-compiler, @gltf-transform/cli, @loaders.gl/core, @loaders.gl/las, @rolldown/plugin-babel, tailwindcss (+11 more)
...
Cohesion: 0.15
Nodes (11): useThemeFlipCursor(), RtScriptedCursor(), ThemeFlipCursor(), useMapMaybe(), Overlays(), Shell(), TourTraceCursor(), useTourStore (+3 more)
...
Cohesion: 0.22
Nodes (5): useCursorAim(), useDemoCursorClick(), useDemoCursorDrop(), useLayersButtonCursor(), LayersButton()

### Community 28 - "Data Table Panel"

Cohesion: 0.33
Nodes (3): Sparkline, STATUS, ZonePreview()
...
Cohesion: 0.12
Nodes (14): DEFAULTS, Knob, KNOBS, ParamKey, CONTOUR, ORIGIN, AppliedLayerId, ChartKind (+6 more)
...
Cohesion: 0.50
Nodes (3): CameraReadout(), CameraState, DebugPanel()
...
Cohesion: 0.20
Nodes (8): CLASS_INFO, CLASS_OTHER, LIDAR_SKY, MODE, POINTCLOUD_ANCHOR, PointCloudHandle, pointCloudTuning, pointCloudView
...
Cohesion: 0.29
Nodes (6): FOLLOW_START_LL, MODE_NAME, nearestT(), splineAt(), usePointCloudChoreography(), PointCloudDirector()

### Community 100 - "Community 100"

Cohesion: 0.40
Nodes (3): TARGET_IDS, useDataTableCursor(), DataTablePanel()

### Community 101 - "Community 101"

Cohesion: 0.40
Nodes (3): Opts, useKanbanCursor(), KanbanPanel()
...
- **Why does `useTourStore` connect `App Shell & Theme Sync` to `Point Cloud Choreography`, `Theme Provider`, `Community 100`, `Community 101`, `Layers Presentation Modal`, `Community 103`, `Airplane Debug Panel`, `Tour Steps Spine`, `Community 106`, `Tech Stack Diagram`, `Ecosystem Bridge Animation`, `Point Cloud Debug Panel`, `Layers Applied Card`, `Gate Nudge & Mobile`, `Airplane & Isochrone Cards`, `Demo Cursor Hooks`, `Layer Card Animations`, `Community 126`?**
