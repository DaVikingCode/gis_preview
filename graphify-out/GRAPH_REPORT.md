# Graph Report - gis_preview  (2026-06-18)

## Corpus Check
- 178 files · ~1,160,499 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1171 nodes · 1381 edges · 118 communities (86 shown, 32 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 218 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ead3e4c`
...
Cohesion: 0.22
Nodes (11): cursorAngle(), dispatchCursor(), SEED_OFFSET, settledAngle(), TourCursor, TourPulse, bezier(), hold() (+3 more)

### Community 2 - "3D Airplane Layer"
Cohesion: 0.08
Nodes (28): addAirplane3D(), addDayNight(), AirplaneLayer, altitudeAt(), apexAt(), CDG, cumulativeLengths(), FlightState (+20 more)
...
Cohesion: 0.05
Nodes (25): useImportPaneReveal(), ImportSimConfig, useImportSimulation(), baseZones, CATEGORIES, Category, CATEGORY_LABELS, CATEGORY_LEGEND (+17 more)
...
Cohesion: 0.08
Nodes (18): BasemapId, BASEMAPS, AnySource, CADASTRE_TPL, Camera, cancelPrewarm(), DEM_TPL, GLOBE_OVERVIEW_CAM (+10 more)

### Community 7 - "shadcn Config"
Cohesion: 0.05
Nodes (44): Env, EventContext, isAllowedOrigin(), json(), MAX, onRequestPost(), aliases, components (+36 more)
...
Cohesion: 0.09
Nodes (22): dependencies, class-variance-authority, clsx, driver.js, gsap, @gsap/react, lucide-react, maplibre-gl (+14 more)
...
Cohesion: 0.11
Nodes (17): useTechStackReveal(), boxShell(), cellBaseZ(), Drawer(), drawerBaseZ(), Face, MAPLIBRE, NODE (+9 more)

### Community 13 - "3D Buildings Layer"
Cohesion: 0.31
Nodes (8): addBuildings3D(), BASE_COLOR_EXPR, BASEMAP_BUILDING_LAYERS, findBasemapPlanetSource(), HEIGHT_COLOR_EXPR, hideBasemapBuildings(), removeBuildings3D(), showBasemapBuildings()

### Community 14 - "Dev Dependencies"
Cohesion: 0.05
Nodes (39): allowScripts, sharp@0.34.5, devDependencies, @babel/core, babel-plugin-react-compiler, @gltf-transform/cli, @loaders.gl/core, @loaders.gl/las (+31 more)
...
Cohesion: 0.10
Nodes (12): useEcosystemBeams(), useEcosystemReveal(), EcosystemBridge(), FORMATS, GlyphProps, Marker, Platform, PLATFORMS (+4 more)
...
Cohesion: 0.10
Nodes (19): AirplaneCard, BasemapChart, BuildingsHeightChart, DataTablePanel, EcosystemBridge, HeatmapChart, HikingChart, IsochroneChart (+11 more)

### Community 21 - "App Shell & Theme Sync"
Cohesion: 0.12
Nodes (11): useThemeFlipCursor(), MobileSidebarTourSync(), SIDEBAR_STEP_IDS, RtScriptedCursor(), ThemeFlipCursor(), Overlays(), Shell(), TourTraceCursor() (+3 more)
...
Cohesion: 0.18
Nodes (7): useRtScriptedCursor(), config, HeatmapChart(), BAND_COLOR, IsochroneChart(), MeasureChart(), useMapDataStore
...
Cohesion: 0.18
Nodes (6): TARGET_IDS, useDataTableCursor(), DataTablePanel(), Sparkline, STATUS, ZonePreview()

### Community 29 - "Layer Card Animations"
Cohesion: 0.05
Nodes (20): useCursorAim(), useDemoCursorClick(), useDemoCursorDrop(), Opts, useKanbanCursor(), useLayerCardsStagger(), useLayersButtonCursor(), useLayerSpotlight() (+12 more)

### Community 30 - "Debug & Start Screen"
Cohesion: 0.12
Nodes (14): CameraState, DebugPanel(), DEFAULTS, Knob, KNOBS, ParamKey, AppliedLayerId, ChartKind (+6 more)

### Community 31 - "Package Overrides"
Cohesion: 0.18
Nodes (7): PosteMarker, RealtimeFeed, RealtimeHandle, RealtimeOpts, RealtimePoste, RealtimeStatus, STATUS_WORD
...
Cohesion: 0.13
Nodes (13): Architecture, Commands, Conventions, End-of-task checklist, graphify, Layer modules (`src/map/layers/`), Map instance access, Review Checklist (+5 more)

### Community 40 - "Tour Steps Spine"
Cohesion: 0.25
Nodes (7): useMapMaybe(), AirplaneDebugPanel(), CameraReadout(), PointCloudDebugPanel(), CONTOUR, ORIGIN, StartScreen()
...
Cohesion: 0.33
Nodes (3): Actions, State, usePreloadStore
...
Cohesion: 0.14
Nodes (8): useGateUnlockNudge(), ChartsPanel(), useIsMobile(), applyBasemap(), DriverInstance, TourController(), waitForStyle(), TourStepper()

### Community 56 - "Import Simulation"
Cohesion: 0.18
Nodes (9): buildContours(), ContourRing, Harmonic, HARMONICS, ContourField(), CoordLabel(), CORNER_SETS, GIS_PRIMITIVES (+1 more)
...
Cohesion: 0.12
Nodes (8): addPointCloud(), fetchJson(), inflight, MaterialUniforms, ModelTransform, openPcCache(), PointCloudLayer, prewarmPointCloud()

### Community 63 - "Traffic Flow Debug Panel"
Cohesion: 0.29
Nodes (5): DEFAULTS, Knob, KNOBS, ParamKey, TrafficFlowDebugPanel()
...
### Community 82 - "Tour Store"
Cohesion: 0.09
Nodes (18): FOLLOW_START_LL, MODE_NAME, nearestT(), splineAt(), usePointCloudChoreography(), CLASS_INFO, CLASS_OTHER, LIDAR_SKY (+10 more)

### Community 87 - "Readme Docs"
Cohesion: 0.40
Nodes (4): React Compiler Convention, Expanding the ESLint configuration, React Compiler, React + TypeScript + Vite

### Community 96 - "Community 96"
Cohesion: 0.22
Nodes (5): useContactExit(), useContactReveal(), ContactPanel(), Field(), Status

### Community 97 - "Community 97"
Cohesion: 0.22
Nodes (8): Codebases, Get Started, How We Use Claude, MCP Servers to Activate, Skills to Know About, Team Tips, Welcome to DaVikingCode, Your Setup Checklist

### Community 98 - "Community 98"
Cohesion: 0.32
Nodes (5): modules, previewForStep(), STEP_PREVIEW_URLS, DotState, StepPreview()

### Community 103 - "Community 103"
Cohesion: 0.50
Nodes (3): CONTOUR, ORIGIN, OutroScreen()

### Community 104 - "Community 104"
Cohesion: 0.50
Nodes (3): buttons, wait, width
...
Cohesion: 0.29
Nodes (6): createTourPulse(), addNetworkFlow(), DASH_SEQ, NetworkFlowHandle, addRealtimeSupervision(), ensureRealtime()

### Community 124 - "Community 124"
Cohesion: 0.33
Nodes (5): addHikingTerrain(), FlightCamera, HikingHandle, PanFlightPlan, prewarmHikingTerrain()

## Knowledge Gaps
- **505 isolated node(s):** `buttons`, `buttons`, `b`, `buttons`, `b` (+500 more)
...
- **Why does `cn()` connect `Sidebar UI Component` to `Layers Presentation Modal`, `Ecosystem Bridge Animation`, `Dropdown Menu Component`, `Chart Primitives`, `Layer Card Animations`, `Dialog Component`, `Sheet Component`, `Stepper Component`, `Table Component`, `Card Component`, `Avatar Component`, `Layers Applied Card`, `Import Simulation`, `Animated Theme Toggler`, `Tabs Component`, `Tooltip Component`, `Badge Component`, `Button Component`, `Scroll Area Component`, `Input Component`, `Progress Component`, `Separator Component`, `Skeleton Component`, `Slider Component`, `Community 96`, `Community 105`, `Community 120`?**
  _High betweenness centrality (0.180) - this node is a cross-community bridge._
- **Why does `useTourStore` connect `App Shell & Theme Sync` to `Theme Provider`, `Layers Presentation Modal`, `Community 103`, `Tour Steps Spine`, `Tech Stack Diagram`, `Ecosystem Bridge Animation`, `Tour Store`, `Debug & Start Screen`, `Layers Applied Card`, `Gate Nudge & Mobile`, `Airplane & Isochrone Cards`, `Data Table Panel`, `Layer Card Animations`, `Community 126`, `Traffic Flow Debug Panel`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `LayersPresentationModal()` connect `Layer Card Animations` to `Sidebar UI Component`, `App Shell & Theme Sync`, `Chart Panel & Charts`, `Layers Presentation Modal`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Are the 98 inferred relationships involving `cn()` (e.g. with `PlatformTile()` and `LayersAppliedCard()`) actually correct?**
  _`cn()` has 98 INFERRED edges - model-reasoned connections that need verification._
- **Are the 29 inferred relationships involving `useTourStore` (e.g. with `useRtScriptedCursor()` and `useThemeFlipCursor()`) actually correct?**
  _`useTourStore` has 29 INFERRED edges - model-reasoned connections that need verification._
- **What connects `buttons`, `buttons`, `b` to the rest of the system?**
  _506 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `3D Airplane Layer` be split into smaller, more focused modules?**
